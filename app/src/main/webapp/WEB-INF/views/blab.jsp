							...
							<li>
								<div>
									...
									<div class="blockquote">
										...
										<span class="date sub-text">by <%= comment.getAuthor().getBlabName() %>by <%= ESAPI.encoder().encodeForHTMLAttribute(comment.getAuthor().getBlabName()) %>										<span class="date sub-text">by <%= comment.getAuthor().getBlabName() %>
