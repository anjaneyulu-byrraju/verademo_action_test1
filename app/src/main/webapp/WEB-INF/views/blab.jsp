							...
							<li>
								<div>
									...
									<div class="blockquote">
										...
										<span class="date sub-text">by <%= comment.getAuthor().getBlabName() %><%= ESAPI.encoder().encodeForHTMLAttribute(comment.getAuthor().()) %>										<span class="date sub-text">by <%= comment.getAuthor().getBlabName() %>
